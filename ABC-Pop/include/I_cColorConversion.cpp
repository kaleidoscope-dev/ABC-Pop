...
ColorHSL I_cColorConversion::RGBtoHSL(const ColorRGB& colorRGB)
{
...
ColorRGB I_cColorConversion::HSLtoRGB(const ColorHSL& colorHSL)
{
...
ColorHSV I_cColorConversion::RGBtoHSV(const ColorRGB& colorRGB)
{
...
ColorRGB I_cColorConversion::HSVtoRGB(const ColorHSV& colorHSV)
{
...
Uint32 I_cColorConversion::RGBtoINT(const ColorRGB& colorRGB)
{
	return 65536 * colorRGB.r + 256 * colorRGB.g + colorRGB.b;
}

ColorRGB I_cColorConversion::INTtoRGB(Uint32 colorINT)
{
	ColorRGB colorRGB;
